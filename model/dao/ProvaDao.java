...
public class ProvaDao extends BaseDao<Prova>{
	...
	public boolean inserir (Prova prova) {
		...
		try {
			...
			pst.setString(2, prova.quantQuestoes());
			pst.setString(3, prova.getDisciplina());
			pst.setLocalDate(4, prova.getData());
			pst.execute();
			return true;		
	...
	public boolean alterar(Prova provinha) {
		...
		try {
			...
			pst.setLocalDate(4, provinha.getData());
			pst.executeUpdate();
			return true;		
	...
	public ResultSet findBySpecifiedField(Prova provazinha, String field) {
		...
		try {
			...
			case "Questao":
				pst.setString(1, provazinha.getQuestao());
				break;
			...
			case "Data":
				pst.setLocalDate(1, provazinha.getData());
				break;
