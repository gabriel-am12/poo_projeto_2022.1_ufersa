...
public class TeladeEditarDisciplinaController {
	...
	@FXML private TableView<DisciplinaDTO> TabelaDisciplinas;
	@FXML private TableColumn<DisciplinaDTO, String> ColunaDisciplinasID;
	@FXML private TableColumn<DisciplinaDTO, String> ColunaDisciplinasNome;
	@FXML private TableColumn<DisciplinaDTO, String> ColunaDisciplinasAssunto;
	...
	public void EditarDisciplina(ActionEvent event){
		DisciplinaDTO disciplina = TabelaDisciplinas.getSelectionModel().getSelectedItem(); 
		try { 
			if (disciplina == null) {
				throw new Exception(); 
				} 
